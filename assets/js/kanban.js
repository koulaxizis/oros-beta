// ============================================
// orOS Kanban — Full Implementation (Fixed v1.2)
// BUILT-IN translations fallback — no dependency on global-settings.js
// ============================================
...
(function() {
  ...
  var BUILTIN_TRANS = {
    en: {
      kanban_add_board: 'Add Board', kanban_add_column: 'Add Column',
      kanban_add_card: 'Add Card', kanban_cancel: 'Cancel', kanban_add: 'Add',
      kanban_search_placeholder: 'Search cards...', kanban_filter: 'Filter',
      kanban_auto_save: 'Auto-save', kanban_empty_title: 'No boards yet',
      kanban_empty_desc: 'Create your first board to get started.',
      kanban_create_first_board: 'Create Board', kanban_board_name: 'Board name:',
      kanban_column_name: 'Column name:', kanban_card_placeholder: 'Enter card title...',
      kanban_due_date: 'Due Date', kanban_clear_due: 'Clear',
      kanban_description: 'Description', kanban_desc_placeholder: 'Add a description...',
      kanban_assignments: 'Assignments', kanban_add_assignment: 'Add Assignment',
      kanban_labels: 'Labels', kanban_manage_labels: 'Manage Labels',
      kanban_new_label: 'New Label', kanban_label_name: 'Label name...',
      kanban_delete_card: 'Delete Card', kanban_save: 'Save',
      kanban_no_board: 'No board to export', toast_downloaded: 'Exported',
      toast_opened: 'Board imported', notes_imported: 'Imported',
      notes_invalid_file: 'Invalid file', notes_import_failed: 'Failed to import',
      text_saved: 'Saved'
    },
    el: {
      kanban_add_board: 'Προσθήκη Board', kanban_add_column: 'Προσθήκη Στήλης',
      kanban_add_card: 'Προσθήκη Κάρτας', kanban_cancel: 'Άκυρο', kanban_add: 'Προσθήκη',
      kanban_search_placeholder: 'Αναζήτηση καρτών...', kanban_filter: 'Φίλτρο',
      kanban_auto_save: 'Αυτόματη αποθήκευση', kanban_empty_title: 'Δεν υπάρχουν boards',
      kanban_empty_desc: 'Δημιούργησε το πρώτο σου board για να ξεκινήσεις.',
      kanban_create_first_board: 'Δημιουργία Board', kanban_board_name: 'Όνομα board:',
      kanban_column_name: 'Όνομα στήλης:', kanban_card_placeholder: 'Εισαγωγή τίτλου κάρτας...',
      kanban_due_date: 'Ημερομηνία Λήξης', kanban_clear_due: 'Καθαρισμός',
      kanban_description: 'Περιγραφή', kanban_desc_placeholder: 'Πρόσθεσε περιγραφή...',
      kanban_assignments: 'Αναθέσεις', kanban_add_assignment: 'Προσθήκη Ανάθεσης',
      kanban_labels: 'Ετικέτες', kanban_manage_labels: 'Διαχείριση Ετικετών',
      kanban_new_label: 'Νέα Ετικέτα', kanban_label_name: 'Όνομα ετικέτας...',
      kanban_delete_card: 'Διαγραφή Κάρτας', kanban_save: 'Αποθήκευση',
      kanban_no_board: 'Δεν υπάρχει board για εξαγωγή', toast_downloaded: 'Εξήχθη',
      toast_opened: 'Το board εισήχθη', notes_imported: 'Εισήχθη',
      notes_invalid_file: 'Μη έγκυρο αρχείο', notes_import_failed: 'Αποτυχία εισαγωγής',
      text_saved: 'Αποθηκεύτηκε'
    },
    es: {
      kanban_add_board: 'Añadir Tablero', kanban_add_column: 'Añadir Columna',
      kanban_add_card: 'Añadir Tarjeta', kanban_cancel: 'Cancelar', kanban_add: 'Añadir',
      kanban_search_placeholder: 'Buscar tarjetas...', kanban_filter: 'Filtrar',
      kanban_auto_save: 'Guardado automático', kanban_empty_title: 'No hay tableros',
      kanban_empty_desc: 'Crea tu primer tablero para empezar.',
      kanban_create_first_board: 'Crear Tablero', kanban_board_name: 'Nombre del tablero:',
      kanban_column_name: 'Nombre de columna:', kanban_card_placeholder: 'Introducir título...',
      kanban_due_date: 'Fecha límite', kanban_clear_due: 'Limpiar',
      kanban_description: 'Descripción', kanban_desc_placeholder: 'Añade una descripción...',
      kanban_assignments: 'Asignaciones', kanban_add_assignment: 'Añadir Asignación',
      kanban_labels: 'Etiquetas', kanban_manage_labels: 'Gestionar Etiquetas',
      kanban_new_label: 'Nueva Etiqueta', kanban_label_name: 'Nombre etiqueta...',
      kanban_delete_card: 'Eliminar Tarjeta', kanban_save: 'Guardar',
      kanban_no_board: 'No hay tablero para exportar', toast_downloaded: 'Exportado',
      toast_opened: 'Tablero importado', notes_imported: 'Importado',
      notes_invalid_file: 'Archivo inválido', notes_import_failed: 'Error al importar',
      text_saved: 'Guardado'
    },
    it: {
      kanban_add_board: 'Aggiungi Board', kanban_add_column: 'Aggiungi Colonna',
      kanban_add_card: 'Aggiungi Carta', kanban_cancel: 'Annulla', kanban_add: 'Aggiungi',
      kanban_search_placeholder: 'Cerca carte...', kanban_filter: 'Filtra',
      kanban_auto_save: 'Salvataggio automatico', kanban_empty_title: 'Nessun board',
      kanban_empty_desc: 'Crea il tuo primo board per iniziare.',
      kanban_create_first_board: 'Crea Board', kanban_board_name: 'Nome board:',
      kanban_column_name: 'Nome colonna:', kanban_card_placeholder: 'Inserisci titolo...',
      kanban_due_date: 'Scadenza', kanban_clear_due: 'Cancella',
      kanban_description: 'Descrizione', kanban_desc_placeholder: 'Aggiungi descrizione...',
      kanban_assignments: 'Assegnazioni', kanban_add_assignment: 'Aggiungi Assegnazione',
      kanban_labels: 'Etichette', kanban_manage_labels: 'Gestisci Etichette',
      kanban_new_label: 'Nuova Etichetta', kanban_label_name: 'Nome etichetta...',
      kanban_delete_card: 'Elimina Carta', kanban_save: 'Salva',
      kanban_no_board: 'Nessun board da esportare', toast_downloaded: 'Esportato',
      toast_opened: 'Board importato', notes_imported: 'Importato',
      notes_invalid_file: 'File non valido', notes_import_failed: 'Importazione fallita',
      text_saved: 'Salvato'
    },
    fr: {
      kanban_add_board: 'Ajouter Tableau', kanban_add_column: 'Ajouter Colonne',
      kanban_add_card: 'Ajouter Carte', kanban_cancel: 'Annuler', kanban_add: 'Ajouter',
      kanban_search_placeholder: 'Rechercher cartes...', kanban_filter: 'Filtrer',
      kanban_auto_save: 'Sauvegarde auto', kanban_empty_title: 'Aucun tableau',
      kanban_empty_desc: 'Créez votre premier tableau pour commencer.',
      kanban_create_first_board: 'Créer Tableau', kanban_board_name: 'Nom du tableau:',
      kanban_column_name: 'Nom de colonne:', kanban_card_placeholder: 'Entrer titre...',
      kanban_due_date: 'Échéance', kanban_clear_due: 'Effacer',
      kanban_description: 'Description', kanban_desc_placeholder: 'Ajoutez une description...',
      kanban_assignments: 'Affectations', kanban_add_assignment: 'Ajouter Affectation',
      kanban_labels: 'Étiquettes', kanban_manage_labels: 'Gérer Étiquettes',
      kanban_new_label: 'Nouvelle Étiquette', kanban_label_name: 'Nom étiquette...',
      kanban_delete_card: 'Supprimer Carte', kanban_save: 'Enregistrer',
      kanban_no_board: 'Aucun tableau à exporter', toast_downloaded: 'Exporté',
      toast_opened: 'Tableau importé', notes_imported: 'Importé',
      notes_invalid_file: 'Fichier invalide', notes_import_failed: 'Échec importation',
      text_saved: 'Enregistré'
    },
    de: {
      kanban_add_board: 'Board hinzufügen', kanban_add_column: 'Spalte hinzufügen',
      kanban_add_card: 'Karte hinzufügen', kanban_cancel: 'Abbrechen', kanban_add: 'Hinzufügen',
      kanban_search_placeholder: 'Karten suchen...', kanban_filter: 'Filter',
      kanban_auto_save: 'Auto-Speichern', kanban_empty_title: 'Keine Boards',
      kanban_empty_desc: 'Erstelle dein erstes Board um zu starten.',
      kanban_create_first_board: 'Board erstellen', kanban_board_name: 'Board-Name:',
      kanban_column_name: 'Spaltenname:', kanban_card_placeholder: 'Titel eingeben...',
      kanban_due_date: 'Fälligkeitsdatum', kanban_clear_due: 'Löschen',
      kanban_description: 'Beschreibung', kanban_desc_placeholder: 'Beschreibung hinzufügen...',
      kanban_assignments: 'Zuweisungen', kanban_add_assignment: 'Zuweisung hinzufügen',
      kanban_labels: 'Labels', kanban_manage_labels: 'Labels verwalten',
      kanban_new_label: 'Neues Label', kanban_label_name: 'Label-Name...',
      kanban_delete_card: 'Karte löschen', kanban_save: 'Speichern',
      kanban_no_board: 'Kein Board zum Exportieren', toast_downloaded: 'Exportiert',
      toast_opened: 'Board importiert', notes_imported: 'Importiert',
      notes_invalid_file: 'Ungültige Datei', notes_import_failed: 'Import fehlgeschlagen',
  ...
  // ========== HELPER: i18n (FIXED: built-in fallback) ==========
  ...
  function getTrans(key) {
    ...
    var bt = BUILTIN_TRANS[lang] || BUILTIN_TRANS.en;
    return bt[key] || key;
  }
  ...
  function createBoard(title) {
    var board = {
      ...
      columns: [
        { id: genId('col'), title: 'To Do', order: 0, cards: [] },
        { id: genId('col'), title: 'Doing', order: 1, cards: [] },
        { id: genId('col'), title: 'Done', order: 2, cards: [] }
      ]
    };
  ...
  function addAssignment(cardId, type, value) {
    ...
    if (!result) return;
    var card = result.card;
    var assignment = { id: genId('asn'), type: type, value: value };
  ...
  function updateAssignment(cardId, asnId, updates) {
    ...
    if (asn) {
      for (var key in updates) { asn[key] = updates[key]; }
      saveData();
    }
  }
  ...
  function renderColumn(col) {
    ...
    addCardInput.placeholder = getTrans('kanban_card_placeholder');
    addCardInput.rows = 1;
    ...
    confirmBtn.textContent = getTrans('kanban_add');

    var cancelBtn = document.createElement('button');
    cancelBtn.className = 'btn-cancel-add-card';
    cancelBtn.textContent = getTrans('kanban_cancel');
    ...
    addCardBtn.innerHTML = '<i class="fa fa-plus"></i> ' + getTrans('kanban_add_card');
  ...
  function exportData() {
    var board = getCurrentBoard();
    if (!board) {
      showToast(getTrans('kanban_no_board'));
      return;
    }
    var exportObj = {
      version: '1.0',
    ...
    reader.onload = function(e) {
      try {
        ...
        if (data.board && data.board.id) {
          ...
          saveData();
          renderAll();
          showToast(getTrans('notes_imported') + ' (' + data.boards.length + ')');
          return;
        } else {
          showToast(getTrans('notes_invalid_file'));
          return;
        }
        ...
        showToast(getTrans('notes_import_failed'));
      }
    };
  ...
  function setup() {
    ...
    if (addBoardDropdownBtn) {
      addBoardDropdownBtn.addEventListener('click', function() {
        var name = prompt(getTrans('kanban_board_name'), 'My Board');
        if (name && name.trim()) {
    ...
    if (addColBtn) {
      addColBtn.addEventListener('click', function() {
        var name = prompt(getTrans('kanban_column_name'), 'New Column');
        if (name && name.trim()) {
    ...
    if (btnAddLabelModal) {
      btnAddLabelModal.addEventListener('click', function() {
        var text = prompt(getTrans('kanban_new_label'), '');
        if (text && text.trim()) {
